 ...
 ******************************************************************************/
package org.fdesigner.runtime.registry.internal.adapter;

import java.util.ArrayList;

import org.fdesigner.runtime.common.internal.runtime.IAdapterFactoryExt;
...
import org.fdesigner.runtime.registry.internal.registry.Handle;
...
class AdapterFactoryProxy implements IAdapterFactory, IAdapterFactoryExt {
	...
	public synchronized IAdapterFactory loadFactory(boolean force) {
		...
		try {
			isActive = org.fdesigner.runtime.registry.internal.registry.osgi.EquinoxUtils.isActive(contributorName);
