...
public class Activator implements BundleActivator, ServiceTrackerCustomizer<Object, Object> {
	 ...
	 */
	private ServiceRegistration<org.fdesigner.core.runtime.preferences.service.prefs.PreferencesService> osgiPreferencesService;
	...
	public void start(BundleContext context) throws Exception {
		...
		if (shouldRegister) {
			...
			osgiPreferencesService = bundleContext.registerService(org.fdesigner.core.runtime.preferences.service.prefs.PreferencesService.class, new OSGiPreferencesServiceManager(bundleContext), null);
		}
