 ...
 *******************************************************************************/
package org.fdesigner.container.internal.location;
...
import org.fdesigner.container.internal.framework.EquinoxConfiguration.ConfigValues;
...
public class EquinoxLocations {
	...
	private static String getEclipseHomeLocation(String launcher, ConfigValues configValues) {
		...
		String macosx = org.fdesigner.supplement.service.environment.Constants.OS_MACOSX;
