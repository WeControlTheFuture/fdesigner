...
import org.fdesigner.runtime.core.internal.runtime.Messages;
...
public abstract class Plugin implements BundleActivator {
	...
	public final Preferences getPluginPreferences() {
		...
		Runnable innerCall = () -> preferencesCopy[0] = new org.fdesigner.runtime.core.internal.preferences.legacy.PreferenceForwarder(
	...
	public final void savePluginPreferences() {
		...
		Runnable innerCall = () -> {
			try {
				((org.fdesigner.runtime.core.internal.preferences.legacy.PreferenceForwarder) preferencesCopy).flush();
			} catch (org.fdesigner.runtime.preferences.service.prefs.BackingStoreException e) {
